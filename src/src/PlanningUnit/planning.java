...
public class planning {
    ...
    public DefaultMutableTreeNode forCPTree = new DefaultMutableTreeNode("agent1");
    public DefaultMutableTreeNode againstCPTree = new DefaultMutableTreeNode("agent2");
    ...
    public void buildAgent1() {
        DefaultMutableTreeNode initial, deterrent, CPBack, murders, notDeterrent, notMurders;
        initial = addLeaf(forCP.get(0)[0], forCPTree,agent.A);

        deterrent = addLeaf(forCP.get(1)[0], initial,agent.A);
        ...
        CPBack = addLeaf(forCP.get(8)[0],initial,agent.A);
        addLeaf(forCP.get(14)[0],CPBack,agent.A);

        murders = addLeaf(forCP.get(9)[0], initial,agent.A);
    ...
    public void buildAgent2(){
        DefaultMutableTreeNode initial, humanLife, innoPeople, rehab, notHumanLife, unlikeInnoPeep;
        initial = addLeaf(againstCP.get(0)[0],againstCPTree,agent.B);

        humanLife = addLeaf(againstCP.get(5)[0],initial,agent.B);
        ...
        innoPeople = addLeaf(againstCP.get(4)[0],initial,agent.B);
        ...
        rehab = addLeaf(againstCP.get(14)[0],initial,agent.B);
